...
function showPage(id) {
  ...
  if (!target) return;
  // Pause le timer quiz si on quitte la page guide
  if(id !== 'guide') clearQuizTimer();
...
const articles = {
  ...
  a7:{
    badges:["b-cdp","b-new"],badgeLabels:["CDP · Officiel","Avril 2026"],
    title:"CDP Sénégal et APDP Bénin signent une convention de coopération régionale",
    date:"Avril 2026",readTime:"4 min",source:"Matin Libre / CDP Sénégal",
    intro:"Le 16 avril 2026 à Cotonou, les deux autorités ont officialisé un partenariat stratégique pour renforcer la protection de la vie privée et la conformité numérique en Afrique de l'Ouest.",
    body:"<h2>Un accord historique entre deux pionniers</h2><p>Le 16 avril 2026, à Cotonou, la Commission de Protection des Données Personnelles du Sénégal (CDP) et l'Autorité de Protection des Données Personnelles du Bénin (APDP-Bénin) ont signé une convention de coopération bilatérale. C'est la première fois que deux autorités francophones d'Afrique de l'Ouest formalisent un tel partenariat.</p><h2>Objectifs du partenariat</h2><p>La convention porte sur trois axes principaux : le partage d'expériences en matière de conformité et de contrôle, la coordination pour les enquêtes transfrontalières impliquant des entreprises opérant dans les deux pays, et l'harmonisation des pratiques de sensibilisation à destination des entreprises et des citoyens.</p><h2>Signal fort pour la région</h2><p>Cet accord s'inscrit dans la dynamique du Réseau Africain des Autorités de Protection des Données (RAPDP) et démontre la volonté des États ouest-africains de bâtir un espace numérique de confiance. Pour les entreprises sénégalaises opérant au Bénin — et vice versa — cela signifie une coopération accrue entre régulateurs et une vigilance renforcée sur les transferts transfrontaliers de données.</p><div class=\"source-box\"><strong>Source :</strong> Matin Libre — 17 avril 2026 / CDP Sénégal</div>"
  },
  a8:{
    badges:["b-cdp","b-new"],badgeLabels:["CDP · Officiel","Avril 2026"],
    title:"CDP + Interpol : formation sur la biométrie sécuritaire pour les forces de défense d'Afrique de l'Ouest",
    date:"Avril 2026",readTime:"5 min",source:"RTS / CDP Sénégal",
    intro:"Le 13 avril 2026 à Dakar, la CDP et Interpol ont lancé une formation dédiée aux experts biométriques des Forces de défense et de sécurité, pour encadrer le traitement des données biométriques dans le respect de la loi.",
    body:"<h2>Biométrie sécuritaire : un enjeu majeur encadré</h2><p>Le 13 avril 2026, la CDP a organisé à Dakar, en partenariat avec Interpol, une session de formation intensive destinée aux experts en biométrie des Forces de défense et de sécurité (FDS) d'Afrique de l'Ouest. Objectif : garantir que les systèmes de reconnaissance biométrique utilisés à des fins sécuritaires respectent les droits fondamentaux et les dispositions de la Loi 2008-12.</p><h2>Pourquoi la biométrie est une donnée sensible</h2><p>Selon l'article 46 de la Loi 2008-12, les données biométriques (empreintes digitales, reconnaissance faciale, iris) constituent des données sensibles nécessitant une autorisation préalable de la CDP avant tout traitement. Leur utilisation par les forces de sécurité doit être strictement proportionnée aux finalités poursuivies.</p><h2>Ce que les participants ont appris</h2><p>La formation a couvert : les bases légales du traitement biométrique en contexte sécuritaire, les obligations de conservation et de sécurisation, les droits des personnes concernées et les recours possibles, et les standards internationaux d'Interpol en matière de données dactyloscopiques.</p><h2>Un modèle pour la sous-région</h2><p>Cette initiative positionne le Sénégal comme un leader en matière de régulation responsable de la biométrie. Elle démontre qu'encadrement juridique et sécurité publique ne sont pas incompatibles, mais complémentaires.</p><div class=\"source-box\"><strong>Source :</strong> RTS Sénégal / CDP Sénégal — 13 avril 2026</div>"
  },
  a9:{
    badges:["b-rgpd","b-new"],badgeLabels:["RGPD · Europe","Janvier 2026"],
    title:"CNIL 2026 : Free Mobile sanctionné à 27M€, France Travail à 5M€ pour violations de données",
    date:"Janvier 2026",readTime:"5 min",source:"CNIL.fr",
    intro:"En janvier 2026, la CNIL a prononcé deux amendes majeures : 27 millions d'euros contre Free Mobile et 5 millions contre France Travail pour défaut de sécurisation des données de millions d'utilisateurs.",
    body:"<h2>Deux décisions qui marquent l'entrée en 2026</h2><p>Le 13 janvier 2026, la CNIL a rendu deux décisions de sanction simultanées. FREE MOBILE a été condamné à 27 millions d'euros pour de multiples manquements au RGPD, et FREE (la maison mère) à 15 millions d'euros pour des infractions connexes. Le 22 janvier 2026, c'est FRANCE TRAVAIL (ex-Pôle Emploi) qui a écopé de 5 millions d'euros pour ne pas avoir sécurisé les données de demandeurs d'emploi.</p><h2>Les manquements reprochés à Free Mobile</h2><p>Les infractions constatées par la CNIL portaient sur : collecte de données sans base légale suffisante, conservation excessive au-delà des durées nécessaires, absence de mesures de sécurité adaptées pour les données des abonnés, et non-respect des droits d'accès exercés par les utilisateurs.</p><h2>France Travail : une faille qui exposait des millions de personnes</h2><p>La sanction contre France Travail fait suite à une violation de données touchant potentiellement 43 millions de personnes. La CNIL a relevé une absence de mesures techniques suffisantes pour prévenir les accès non autorisés, en violation de l'article 32 du RGPD.</p><h2>Ce que cela signifie pour les entreprises sénégalaises</h2><p>Ces sanctions confirment que la sécurisation des données n'est pas optionnelle. Pour toute organisation traitant des données de résidents européens (Art. 3 RGPD), les obligations de sécurité (Art. 32) s'appliquent pleinement. Une startup sénégalaise ayant des clients en Europe doit intégrer dès maintenant ces exigences.</p><div class=\"source-box\"><strong>Source :</strong> CNIL.fr — Décisions du 13 et 22 janvier 2026</div>"
  }
};
...
document.addEventListener('click', function(e) {
  ...
  t = e.target.closest ? e.target.closest('[data-nl-unsub-toggle]') : null;
  if(t) { var f=document.getElementById('nl-unsub-form'); if(f){f.style.display=f.style.display==='none'?'block':'none';} return; }
  t = e.target.closest ? e.target.closest('[data-nl-desabonner]') : null;
  if(t) { var uEmail=document.getElementById('nl-unsub-email'); if(!uEmail||!uEmail.value.trim()){showToast('Entrez votre email d\'inscription.');return;} t.textContent='Envoi...';t.disabled=true; fetch('/api/newsletter/desabonner',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({email:uEmail.value.trim()})}).then(function(r){return r.json();}).then(function(data){t.textContent=data.success?'Desabonnement confirme !':data.message;t.style.background=data.success?'rgba(255,255,255,.25)':'rgba(255,100,100,.3)';if(data.success){uEmail.value='';setTimeout(function(){var f2=document.getElementById('nl-unsub-form');if(f2)f2.style.display='none';t.textContent='Se desabonner';t.style.background='';t.disabled=false;},3000);}else{setTimeout(function(){t.textContent='Se desabonner';t.style.background='';t.disabled=false;},3000);}}).catch(function(){t.textContent='Se desabonner';t.disabled=false;showToast('Erreur serveur.');}); return; }
  t = e.target.closest ? e.target.closest('[data-contact-btn]') : null;
  if(t) { var nom=document.getElementById('c-nom'); var email=document.getElementById('c-email'); var org=document.getElementById('c-org'); var besoin=document.getElementById('c-besoin'); var msg=document.getElementById('c-message'); if(!nom||!nom.value.trim()){showToast('Veuillez entrer votre nom.');return;} if(!email||!email.value.trim()||!/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(email.value.trim())){showToast('Veuillez entrer une adresse email valide.');return;} if(!msg||!msg.value.trim()||msg.value.trim().length<10){showToast('Le message doit contenir au moins 10 caractères.');return;} t.textContent='Envoi...'; t.disabled=true; fetch('/api/contact',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({nom:nom.value.trim(),email:email.value.trim(),organisation:org?org.value:'',type_besoin:besoin?besoin.value:'',message:msg.value.trim()})}).then(function(r){return r.json();}).then(function(data){t.textContent='Message envoye !';t.style.background='#2d8a52';if(nom)nom.value='';if(email)email.value='';if(org)org.value='';if(besoin)besoin.value='';if(msg)msg.value='';setTimeout(function(){t.textContent='Envoyer';t.style.background='';t.disabled=false;},4000);}).catch(function(){t.textContent='Envoyer';t.disabled=false;showToast('Erreur serveur.');}); return; }
